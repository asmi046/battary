...
return [
    ...
    'title' => env('MOONSHINE_TITLE', 'Сеть магазинов «Батарейка»'),
    'logo' => env('MOONSHINE_LOGO', 'img/logo-moon.webp'),
    'logo_small' => env('MOONSHINE_LOGO_SMALL', 'img/logo-mini-moon.webp'),
